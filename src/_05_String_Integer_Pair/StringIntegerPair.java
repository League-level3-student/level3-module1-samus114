...
private int[] values;
	...
	public void put(String key, int value) {
		// A. iterate through the keys. If you find a key that matches the passed in String, set the value at that location to the passed in value and return from the method.
...
return Integer.MIN_VALUE;
	...
	// 6. Complete the containsKey method so that it returns true if the passed in keys is contained in the keys array
	...
	// 7. Complete the containsValue method so that it returns true if the passed in value is contained in the values array
